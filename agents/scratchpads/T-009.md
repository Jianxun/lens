...
- 2025-12-25: Ran `npm run build` post-backend fix; pushed branch and opened PR #7.
...
- `. .venv/bin/activate && python - <<'PY' from backend.main import create_app; create_app(); PY` (app builds)
